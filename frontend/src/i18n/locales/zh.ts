export default {
  ...
  keys: {
    ...
    keyUnavailable: '完整密钥仅显示一次，请创建新密钥以再次查看。',
    keyUnavailableShort: '不可用',
  ...
  admin: {
    ...
    settings: {
      ...
      turnstile: {
        ...
        secretKeyPlaceholder: '请输入 Turnstile 私密密钥',
        secretKeyPlaceholderSet: '密钥已设置（留空可保留）',
      },
      defaults: {
        title: '用户默认设置',
        description: '新用户的默认值',
      ...
      smtp: {
        ...
        passwordPlaceholderSet: '密码已设置（留空可保留）',
        fromEmail: '发件人邮箱',
        fromName: '发件人名称',
        useTls: '使用 TLS',
