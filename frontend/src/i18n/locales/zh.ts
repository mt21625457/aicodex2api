export default {
  ...
  admin: {
    ...
    users: {
      ...
      none: '无',
      groupChangedSuccess: '分组更换成功',
      groupChangeFailed: '更换分组失败',
      groupChangedWithGrant: '分组更换成功，并已自动授予用户分组权限：{group}',
      noUsersYet: '暂无用户',
    ...
    accounts: {
      ...
      bulkEdit: {
        ...
        scopeTitle: '批量编辑范围',
        scopeInfo: '已选择 {count} 个账号，请先选择平台和账号类型。',
        onlySameTypeHint: '仅会批量编辑“同平台 + 同账号类型”的账号，其他已选账号不会被修改。',
        choosePlatform: '请选择平台',
        chooseType: '请选择账号类型',
        scopeMatched: '符合条件账号：{count} 个',
        scopeSummaryTitle: '选中范围统计',
        scopeTargetPreview: '本次将编辑 {matched}/{selected} 个已选账号。',
        scopeExcludedHint: '有 {count} 个已选账号不在当前范围内，不会被编辑。',
        unsupportedScope: '当前范围暂不支持批量编辑',
        openScopedEditor: '打开批量编辑器',
        noScopedMatch: '当前筛选下没有可编辑账号，请重新选择',
        loadSelectionFailed: '读取选中账号失败（{count} 个），请重试',
        ...
        templateTitle: '批量模板',
        templateScopeHint: '模板仅作用于当前范围：{platform} / {type}',
        templateLoading: '正在加载模板...',
        templateSelectLabel: '已保存模板',
        templateEmpty: '暂无模板',
        templateApply: '应用',
        templateDelete: '删除',
        templateNameLabel: '模板名称',
        templateNamePlaceholder: '例如：OpenAI OAuth 默认配置',
        templateShareScopeLabel: '共享范围',
        templateShareScopePrivate: '仅自己可见',
        templateShareScopeTeam: '团队管理员可见',
        templateShareScopeGroups: '按分组可见',
        templateShareGroupsLabel: '可见分组',
        templateShareGroupsHint: '仅当当前批量编辑命中分组与所选分组有交集时可见。',
        templateShareGroupsRequired: '分组共享模板至少需要选择一个分组',
        templateSave: '保存模板',
        templateNameRequired: '请先输入模板名称',
        templateSaved: '模板“{name}”已保存',
        templateApplied: '已应用模板“{name}”',
        templateDeleted: '模板“{name}”已删除',
        templateDeleteConfirm: '确定删除模板“{name}”？该操作不可撤销。',
        templateStorageFailed: '保存到本地模板失败',
        templateLoadFailed: '加载模板失败',
        templateSaveFailed: '保存模板失败',
        templateDeleteFailed: '删除模板失败',
        templateVersionTitle: '版本历史',
        templateVersionHint: '每次更新都会自动快照当前模板配置。',
        templateVersionLoading: '正在加载版本历史...',
        templateVersionEmpty: '暂无历史版本',
        templateVersionUnknownTime: '未知时间',
        templateVersionLoadFailed: '加载模板版本历史失败',
        templateRollback: '回滚',
