export default {
  ...
  admin: {
    ...
    users: {
      ...
      none: 'None',
      groupChangedSuccess: 'Group changed successfully',
      groupChangeFailed: 'Failed to change group',
      groupChangedWithGrant: 'Group changed successfully and user access was granted for {group}',
    ...
    accounts: {
      ...
      bulkEdit: {
        ...
        scopeTitle: 'Bulk Edit Scope',
        scopeInfo: '{count} account(s) selected. Choose platform and account type first.',
        onlySameTypeHint:
          'Only accounts in the same platform + type scope will be edited; other selected accounts stay unchanged.',
        choosePlatform: 'Please choose a platform',
        chooseType: 'Please choose an account type',
        scopeMatched: 'Matched accounts: {count}',
        scopeSummaryTitle: 'Selected Scope Summary',
        scopeTargetPreview: 'This update will apply to {matched} of {selected} selected account(s).',
        scopeExcludedHint: '{count} selected account(s) are out of current scope and will not be edited.',
        unsupportedScope: 'Unsupported scope',
        openScopedEditor: 'Open Bulk Editor',
        noScopedMatch: 'No editable accounts match the selected scope',
        loadSelectionFailed: 'Failed to load selected accounts ({count}). Please retry.',
        ...
        templateTitle: 'Edit Templates',
        templateScopeHint: 'Templates are scoped to {platform} / {type}.',
        ...
        templateNamePlaceholder: 'e.g. OpenAI OAuth baseline',
        templateShareScopeLabel: 'Share scope',
        templateShareScopePrivate: 'Only me',
        templateShareScopeTeam: 'All admins',
        templateShareScopeGroups: 'Scoped groups',
        templateShareGroupsLabel: 'Visible groups',
        templateShareGroupsHint: 'Only appears when current bulk-edit scope intersects selected groups.',
        templateShareGroupsRequired: 'Choose at least one group for group-shared template',
        ...
        templateDeleteConfirm: 'Delete template "{name}"? This action cannot be undone.',
        templateStorageFailed: 'Failed to save template to local storage',
        ...
        templateVersionTitle: 'Version history',
        templateVersionHint: 'Each update snapshots previous template state.',
        templateVersionLoading: 'Loading version history...',
        templateVersionEmpty: 'No historical versions yet',
        templateVersionUnknownTime: 'Unknown time',
        templateVersionLoadFailed: 'Failed to load template version history',
        templateRollback: 'Rollback',
