export default {
  ...
  keys: {
    ...
    keyUnavailable: 'Full key is only shown once. Create a new key to view it again.',
    keyUnavailableShort: 'Unavailable',
  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        step3: 'Go to the Application tab',
    ...
    settings: {
      ...
      turnstile: {
        ...
        secretKeyPlaceholderSet: 'Secret key is set (leave blank to keep)',
      },
      defaults: {
      ...
      smtp: {
        ...
        passwordPlaceholderSet: 'Password is set (leave blank to keep)',
