...
const keyword = (text: string) => `<span class="text-purple-400">${escapeHtml(text)}</span>`
const variable = (text: string) => `<span class="text-cyan-400">${escapeHtml(text)}</span>`
const string = (text: string) => `<span class="text-green-400">${escapeHtml(text)}</span>`
const operator = (text: string) => `<span class="text-yellow-400">${escapeHtml(text)}</span>`
const comment = (text: string) => `<span class="text-gray-500">${escapeHtml(text)}</span>`
const key = (text: string) => `<span class="text-blue-400">${escapeHtml(text)}</span>`
