...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			backupjob.Table:          backupjob.ValidColumn,
			backupjobevent.Table:     backupjobevent.ValidColumn,
			backups3config.Table:     backups3config.ValidColumn,
			backupsetting.Table:      backupsetting.ValidColumn,
			backupsourceconfig.Table: backupsourceconfig.ValidColumn,
		})
	})
